...
# ========== VIEW 2: MULTI-YEAR HEATMAP ==========
    ...
    if df.empty:
        ...
        The year 2011 stands out as one of the most catastrophic tornado seasons in U.S. history, marked by an extraordinary level of tornado activity and devastation. Central to this was the [April 25–28 Super Outbreak](https://www.weather.gov/bmx/event_04272011), which unleashed **360 tornadoes across 21 states**, including four EF5 tornadoes—the highest rating on the Enhanced Fujita scale ([NOAA, 2011](https://www.noaa.gov/stories/april-25-28-2011-super-outbreak-largest-tornado-outbreak-in-us-history)). On April 27 alone, a record-shattering **219 tornadoes** were confirmed, making it the most active tornado day ever recorded ([National Weather Service, 2021](https://www.weather.gov/bmx/event_04272011)). The human toll was staggering, with **324 tornado-related deaths**, **238 of which occurred in Alabama alone**, and an additional **24 fatalities** caused by related thunderstorm events ([NOAA, 2011](https://www.noaa.gov/stories/april-25-28-2011-super-outbreak-largest-tornado-outbreak-in-us-history)). April 2011 saw a total of **758 tornadoes**, making it the **single most active tornado month** in U.S. history ([Storm Prediction Center, 2011](https://www.spc.noaa.gov/wcm/april2011summary.html)). This unparalleled outbreak not only redefined the scale of tornado disasters but also revealed how a short window of extreme weather can account for a significant portion of yearly destruction and loss of life.

        Building on lessons from historic events like 2011, it becomes clear that uncovering temporal and seasonal tornado patterns is crucial for both understanding and preparedness. Tornadoes are among the most destructive natural phenomena, and their behavior—when examined over time and across impact metrics—can provide key insights into risk ([American Meteorological Society, 2024](https://glossary.ametsoc.org/wiki/Tornado)). This interactive visualization allows users to explore tornado occurrences and their effects across time, seasonality, and different impact dimensions, unlocking patterns that are often hidden in raw data.
